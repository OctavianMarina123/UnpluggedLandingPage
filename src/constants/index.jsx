export const features = [
    {
        id: "0",
        icon: "/mockups/LoggedInHome-portrait.png",
        caption: "Stay Present",
        title: "Choose Your Mode",
        text: "Whether you’re with friends, your partner, or enjoying some time with yourself, choose between Group Vibes, Couple Time, or Solo Challenge. Each mode helps you stay off your phone and fully engage with the present moment.",
        button: {
    ...
    {
        id: "1",
        icon: "/mockups/GroupVibesStartSession-portrait.png",
        caption: "Quick and Easy",
        title: "Join via QR Code",
        text: "Starting a session has never been easier. Simply scan the QR code to invite friends and family. In just a few seconds, everyone is connected and ready to enjoy a distraction-free experience together.",
        button: {
    ...
    {
        id: "3",
        icon: "/mockups/CoupleTime-portrait.png",
        caption: "Be Present Together",
        title: "Stay Engaged Without Phones",
        text: "Once the session starts, put your phone aside and stay in the moment with those around you. No distractions, no interruptions—just meaningful connections. Complete the challenge without leaving the app.",
        button: {
            icon: "/images/docs.svg",
            title: "Read the docs",
        },
    ...
    {
        id: "4",
        icon: "/mockups/SoloTimeStartSession-portrait.png",
        caption: "Master Your Focus",
        title: "Solo Time Challenge",
        text: "Take a break from your phone and focus on what matters. Set your timer, commit to your goal, and see how much you can achieve when you’re fully present with yourself.",
        button: {
            icon: "/images/docs.svg",
            title: "Read the docs",
        },
...
export const details = [
    {
        id: "0",
        icon: "/images/group-vibes.png",
        title: "Stay off your phone with friends",
    },
    {
        id: "1",
        icon: "/images/couple-time.png",
        title: "Reconnect with your partner",
    },
    {
        id: "2",
        icon: "/images/solo-challenge.png",
        title: "Focus solo with phone-free challenges",
    },
];
...
export const faq = [
    {
        ...
        answer:
            "This app is designed for people who want to spend more quality time with their friends, family, partner, or even with themselves, away from distractions.",
    },
    {
        id: "1",
        question: "What is Early Premium?",
        answer:
            "Early Premium is for users who submit their email to be notified about the app's launch. As a thank you for being early supporters, they will receive a free Premium subscription once the app is launched.",
    },
    {
        id: "2",
        question: "How does the app work?",
        answer:
            "You can join a session solo or in a group where the goal is to stay present and avoid using your phone. If you leave the app or open other apps, you’ll be disqualified from the session.",
    },
    {
        id: "3",
        question: "What problem does the app solve?",
        answer:
            "The app helps people avoid losing valuable time on apps like Instagram or TikTok when spending time together. It encourages real-world connections and being present in the moment.",
    },
    {
        id: "4",
        question: "When will the app be launched?",
        answer:
            "The app is expected to launch at the beginning of 2025.",
    },
    {
        id: "5",
        question: "What platforms is the app available on?",
        answer:
            "The app will initially be available on iOS, with plans to expand to Android in the future.",
    },
    {
        id: "6",
        question: "Can I use the app alone?",
        answer:
            "Yes! You can enter solo sessions where you challenge yourself to stay present and avoid using your phone.",
    },
    {
        id: "7",
        question: "Can I use the app with a group?",
        answer:
            "Absolutely! The app allows you to join group sessions where everyone must avoid using their phones. The first person to open another app loses the challenge.",
    },
    {
        id: "8",
        question: "What happens if I leave the app during a session?",
        answer:
            "If you exit the app or switch to another app during a session, you will be disqualified from the challenge.",
    },
    {
        id: "9",
        question: "How can I invite my friends or family to join a session?",
        answer:
            "Once you create a session, you can invite others by sharing a QR code or a unique link. They can join the session by scanning the code or clicking the link.",
    },
];
export const plans = [
    {
        ...
        priceMonthly: 0,
        priceYearly: 0,
        caption: "Great for casual users",
        features: [
            "10 solo or couple sessions per month",
    ...
    },
    {
        ...
        priceMonthly: 0,
        priceYearly: 0,
        caption: "Get Free Premium Access",
        description: "Submit your email and enjoy two months of full premium access for free.",
        features: [
            "Unlimited sessions (solo, couple, group)",
            "Access to statistics and performance insights",
    ...
    },
    {
        ...
        priceMonthly: 7,
        priceYearly: 3,
        caption: "Best value for frequent users",
        features: [
            "Unlimited solo, couple, and group sessions",
